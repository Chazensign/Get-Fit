...
//   const nutLabel = useRef()

//    useLayoutEffect(() => {
//     const $nutLabel = $(nutLabel.current)
//     const handleChange = (e) => {
//       props.onChange(e.target.value)
//     }
//     $(nutLabel).nutritionLabel({
...
//    })
//     $nutLabel.on('change',handleChange)
//     $nutLabel.trigger("chosen:updated")
//     $nutLabel.trigger("chosen:updated")
    
//     return () => {
//       $nutLabel.off('change', handleChange);
//       $nutLabel.nutritionLabel('destroy');
